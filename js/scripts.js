...
var LookoutTower = new Place('Indian Ridge Lookout Tower', 'Oregon', ['Volcanos', 'Lakes', 'Flowers', 'Old Growth Forest'], ['Your own camp made food'], 'The roads are full of potholes and washouts, only passable by high clearence vehicles');
...
$(document).ready(function() {
  $('.formOne').submit(function(event) {
    ...
    console.log("here");
    $('#display').text(Korea.paragraphDisplay());
  });
});
$(document).ready(function() {
  $('.formTwo').submit(function(event) {
    event.preventDefault();
    console.log("here");
    $('#display').text(LookoutTower.paragraphDisplay());
  });
});
